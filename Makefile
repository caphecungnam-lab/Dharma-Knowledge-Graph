.PHONY: all validate build report quality export-neo4j export-rdf build-index dashboard health health-strict source-registry add-source-example download-transcript-example test docs-links check clean
...
check: validate report quality export-neo4j export-rdf docs-links test
	python3 -m py_compile build_backend/dharma_build.py src/dharma_kg/citations.py src/dharma_kg/youtube.py src/dharma_kg/registry.py src/dharma_kg/quality.py scripts/build_graph.py scripts/validate_seed_data.py scripts/import_manual_transcript.py scripts/vtt_to_evidence.py scripts/review_evidence.py scripts/batch_review_helper.py scripts/promote_reviewed_evidence.py scripts/build_curated_index.py scripts/build_corpus_dashboard.py scripts/source_registry.py scripts/add_new_source.py scripts/download_transcript.py scripts/search_curated_evidence.py scripts/ask_curated_evidence.py scripts/write_graph_report.py scripts/write_quality_report.py scripts/export_neo4j_csv.py scripts/export_rdf_turtle.py scripts/validate_docs_links.py
